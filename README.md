...
An intelligent, AI-powered news aggregation system using GPT-4.1 and GPT-4o-mini that automatically scrapes, processes, and delivers personalized AI news digests via email. The system uses LLMs to summarize content, rank articles based on user preferences, and generate personalized email newsletters.
